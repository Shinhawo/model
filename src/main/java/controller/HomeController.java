...
//		request.setAttribute("p3", "");
//		
		// home.jsp에서 표현할 데이터를 요청객체에 저장하기
//		request.setAttribute("item1", List.of(product1, product2));
//		request.setAttribute("item2", List.of());
//		request.setAttribute("item3", Map.of("name", "홍길동", "email", "hong@gmail.com"));
//		request.setAttribute("item4", Map.of());
